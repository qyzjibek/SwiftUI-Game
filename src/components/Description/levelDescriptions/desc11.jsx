    ...
    return (
         <>
            <div className='instructions'>
                ...
                <p>cFor example, use a <span style={{color: "#8c28c2"}}>Divider</span>  in a VStack to create a horizontal line between vertically laid out elements:</p>
...
`}
                ...
                <img style={{width: "250px", margin: "10px"}} src="https://bananadocs-documentation-assets.s3-us-west-2.amazonaws.com/Divider-example-1.png"/>
...
`}
                ...
                <img style={{width: "250px", margin: "10px"}} src="https://bananadocs-documentation-assets.s3-us-west-2.amazonaws.com/Horizontally-Split-Text.png"/>
...
`}
                ...
                <img style={{width: "250px", margin: "10px"}} src="https://bananadocs-documentation-assets.s3-us-west-2.amazonaws.com/divider-colored.png"/>
            </div>
        </>
    );
};